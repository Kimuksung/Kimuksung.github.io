---
layout: post
title:  "가상 로그 데이터 실시간 처리 구성하기 With. Kafka, Spark, Hadoop"
author: Kimuksung
categories: [ Kafka, Hadoop, Spark ]
tags: [ Python, Kafka, Hadoop, Spark, Docker, AWS ]
...
---
- Ec2 Instance Kafka ,Hadoop Cluster 구성 - [Kafka CLuster 구성 링크](https://kimuksung.github.io/KafkaCluster_ec2/) , [Hadoop CLuster 구성 링크](https://kimuksung.github.io/ClusterHadoop4-Ec2/)
- Spark와 Jupyter는 Docker에 구성 - [Spark 구성 링크](https://kimuksung.github.io/Spark-Cluster/)
- Spark로 Kafka, Hadoop 연결 및 처리 가능한 환경 구성 - [Kafka 연결하기](https://kimuksung.github.io/spark_connect_kafka/) , [Hadoop 연결하기](https://kimuksung.github.io/spark_connect_hadoop/), [stream 연결하기](https://kimuksung.github.io/upload_streaming_kafka_spark_hdfs/)
- Python으로 가상의 로그 데이터 생성 파일 구성 - [로그 데이터 생성 링크](https://kimuksung.github.io/python_generate_log/)
- 로그 데이터 전처리 및 Produce 처리 - [전처리 및 Produce 링크  ](https://kimuksung.github.io/python_log_data_produce/)
...
<title>streaming_test</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<p>- SparkSession으로 Kafka 연결하기</p>
<div id="cell-id=f383de13" class="jp-Cell jp-CodeCell jp-Notebook-cell   ">
...
<span class="kn">from</span> <span class="nn">pyspark.sql.functions</span> <span class="kn">import</span> <span class="n">col</span><span class="p">,</span> <span class="n">concat</span><span class="p">,</span> <span class="n">lit</span>
...
<span class="n">scala_version</span> <span class="o">=</span> <span class="s1">&#39;2.12&#39;</span>  
<span class="n">spark_version</span> <span class="o">=</span> <span class="s1">&#39;3.1.1&#39;</span>
<span class="n">packages</span> <span class="o">=</span> <span class="p">[</span>
    <span class="sa">f</span><span class="s1">&#39;org.apache.spark:spark-sql-kafka-0-10_</span><span class="si">{</span><span class="n">scala_version</span><span class="si">}</span><span class="s1">:</span><span class="si">{</span><span class="n">spark_version</span><span class="si">}</span><span class="s1">&#39;</span><span class="p">,</span>
    <span class="s1">&#39;org.apache.kafka:kafka-clients:3.2.0&#39;</span>
<span class="p">]</span>
...
<span class="n">spark</span> <span class="o">=</span> <span class="n">SparkSession</span><span class="o">.</span><span class="n">builder</span>\
    ...
    <span class="o">.</span><span class="n">appName</span><span class="p">(</span><span class="s2">&quot;kafka-example&quot;</span><span class="p">)</span>\
    <span class="o">.</span><span class="n">config</span><span class="p">(</span><span class="s2">&quot;spark.jars.packages&quot;</span><span class="p">,</span> <span class="s2">&quot;,&quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">packages</span><span class="p">))</span>\
...
<pre>:: loading settings :: url = jar:file:/usr/local/lib/python3.9/dist-packages/pyspark/jars/ivy-2.4.0.jar!/org/apache/ivy/core/settings/ivysettings.xml
</pre>
</div>
</div>
<div class="jp-OutputArea-child">
...
<pre>Ivy Default Cache set to: /root/.ivy2/cache
The jars for the packages stored in: /root/.ivy2/jars
org.apache.spark#spark-sql-kafka-0-10_2.12 added as a dependency
org.apache.kafka#kafka-clients added as a dependency
:: resolving dependencies :: org.apache.spark#spark-submit-parent-69972b37-dec6-4a2b-90c0-d1849abeaf02;1.0
	confs: [default]
...
:: resolution report :: resolve 189ms :: artifacts dl 5ms
	...
	:: evicted modules:
	org.apache.kafka#kafka-clients;2.6.0 by [org.apache.kafka#kafka-clients;3.2.0] in [default]
	---------------------------------------------------------------------
	|                  |            modules            ||   artifacts   |
	...
	---------------------------------------------------------------------
:: retrieving :: org.apache.spark#spark-submit-parent-69972b37-dec6-4a2b-90c0-d1849abeaf02
	confs: [default]
	0 artifacts copied, 9 already retrieved (0kB/5ms)
23/10/14 05:06:39 WARN NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable
Using Spark&#39;s default log4j profile: org/apache/spark/log4j-defaults.properties
Setting default log level to &#34;WARN&#34;.
To adjust logging level use sc.setLogLevel(newLevel). For SparkR, use setLogLevel(newLevel).
23/10/14 05:06:39 WARN Utils: Service &#39;SparkUI&#39; could not bind on port 4040. Attempting port 4041.
</pre>
</div>
</div>
...
<div class="jp-RenderedHTMLCommon jp-RenderedHTML jp-OutputArea-output jp-OutputArea-executeResult" data-mime-type="text/html">
        ...
        <div>
            ...
            <p><a href="http://daf70f69d60b:4041">Spark UI</a></p>
...
</div><div id="cell-id=8273df9f" class="jp-Cell jp-CodeCell jp-Notebook-cell   ">
<p>- Kafka 데이터 stream Consume 하기</p>
<div class="jp-Cell-inputWrapper">
<div class="jp-Collapser jp-InputCollapser jp-Cell-inputCollapser">
</div>
<div class="jp-InputArea jp-Cell-inputArea">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Kafka Consume Stream</span>
<span class="n">kafkaDf</span> <span class="o">=</span> <span class="n">spark</span><span class="o">.</span><span class="n">readStream</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="s2">&quot;kafka&quot;</span><span class="p">)</span>\
  <span class="o">.</span><span class="n">option</span><span class="p">(</span><span class="s2">&quot;kafka.bootstrap.servers&quot;</span><span class="p">,</span> <span class="s2">&quot;master:9092, worker:9092&quot;</span><span class="p">)</span>\
  <span class="o">.</span><span class="n">option</span><span class="p">(</span><span class="s2">&quot;subscribe&quot;</span><span class="p">,</span> <span class="s1">&#39;log&#39;</span><span class="p">)</span>\
...
<span class="n">query</span> <span class="o">=</span> <span class="n">kafkaDf</span><span class="o">.</span><span class="n">selectExpr</span><span class="p">(</span><span class="s2">&quot;CAST(value AS STRING)&quot;</span><span class="p">)</span> \
...
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="application/vnd.jupyter.stderr">
<pre>23/10/14 05:10:02 WARN StreamingQueryManager: Temporary checkpoint location created which is deleted normally when the query didn&#39;t fail: /tmp/temporary-11440d35-73c2-4501-9d97-d1e0da7584fb. If it&#39;s required to delete it under any circumstances, please set spark.sql.streaming.forceDeleteTempCheckpointLocation to true. Important to know deleting temp checkpoint folder is best effort.
</pre>
</div>
</div>
<div class="jp-OutputArea-child">
...
</div><div id="cell-id=ac749ee3" class="jp-Cell jp-CodeCell jp-Notebook-cell   ">
<p>- HDFS에 stream 데이터 저장하기</p>
<div class="jp-Cell-inputWrapper">
<div class="jp-Collapser jp-InputCollapser jp-Cell-inputCollapser">
</div>
<div class="jp-InputArea jp-Cell-inputArea">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Write stream - HDFS</span>
<span class="c1"># Update 해보기</span>
<span class="n">query2</span> <span class="o">=</span> <span class="n">kafkaDf</span><span class="o">.</span><span class="n">selectExpr</span><span class="p">(</span><span class="s2">&quot;CAST(value AS STRING)&quot;</span><span class="p">)</span> \
<span class="o">.</span><span class="n">writeStream</span> \
...
<span class="o">.</span><span class="n">option</span><span class="p">(</span><span class="s2">&quot;checkpointLocation&quot;</span><span class="p">,</span> <span class="s2">&quot;/check/log&quot;</span><span class="p">)</span> \
<span class="o">.</span><span class="n">option</span><span class="p">(</span><span class="s2">&quot;path&quot;</span><span class="p">,</span> <span class="sa">f</span><span class="s2">&quot;hdfs://hdfs-public-ip:9000/test/log_dir/</span><span class="si">{</span><span class="n">current_date</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span> \
<span class="o">.</span><span class="n">start</span><span class="p">()</span>
</pre></div>
...
|value                                                                                                                                                                                                                                                                                                                                                                            |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|{&#34;userid&#34;: &#34;c71729ab-1e5a-4960-80d1-22b64603faec&#34;, &#34;ip&#34;: &#34;178.235.138.39&#34;, &#34;log_time&#34;: &#34;2023-10-13 17:48:35+0900&#34;, &#34;method&#34;: &#34;GET&#34;, &#34;status&#34;: &#34;200&#34;, &#34;url&#34;: &#34;http://donaldson.com/mainlogin.html&#34;, &#34;agent&#34;: &#34;Mozilla/5.0 (Android 4.3.1; Mobile; rv:54.0) Gecko/54.0 Firefox/54.0\n&#34;}                                                                                            |
...
|value                                                                                                                                                                                                                                                                                                                                                              |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|{&#34;userid&#34;: &#34;56719ef3-6616-4471-ad1f-1ef65df14572&#34;, &#34;ip&#34;: &#34;7.210.236.222&#34;, &#34;log_time&#34;: &#34;2023-10-13 21:20:52+0900&#34;, &#34;method&#34;: &#34;PUT&#34;, &#34;status&#34;: &#34;200&#34;, &#34;url&#34;: &#34;http://jones.biz/main/listmain.html&#34;, &#34;agent&#34;: &#34;Mozilla/5.0 (X11; Linux x86_64; rv:1.9.5.20) Gecko/3851-05-01 01:42:23 Firefox/3.8\n&#34;}                                                                 |
...
</div><div id="cell-id=3256cf21" class="jp-Cell jp-CodeCell jp-Notebook-cell   ">
<div class="jp-Cell-inputWrapper">
<div class="jp-Collapser jp-InputCollapser jp-Cell-inputCollapser">
</div>
<div class="jp-InputArea jp-Cell-inputArea">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">kafkaDf</span><span class="o">.</span><span class="n">printSchema</span><span class="p">())</span>
</pre></div>
...
</div><div id="cell-id=929dd4f7" class="jp-Cell jp-CodeCell jp-Notebook-cell jp-mod-noOutputs  ">
<div class="jp-Cell-inputWrapper">
<div class="jp-Collapser jp-InputCollapser jp-Cell-inputCollapser">
</div>
<div class="jp-InputArea jp-Cell-inputArea">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">query</span><span class="o">.</span><span class="n">awaitTermination</span><span class="p">()</span>
<span class="n">query2</span><span class="o">.</span><span class="n">awaitTermination</span><span class="p">()</span>
</pre></div>
...
</div><div id="cell-id=5e12adce" class="jp-Cell jp-CodeCell jp-Notebook-cell jp-mod-noOutputs  ">
<div class="jp-Cell-inputWrapper">
<div class="jp-Collapser jp-InputCollapser jp-Cell-inputCollapser">
</div>
<div class="jp-InputArea jp-Cell-inputArea">
...
<a href="https://ibb.co/D8YygB1"><img src="https://i.ibb.co/nnBv8Xw/2023-10-14-3-58-57.png" alt="2023-10-14-3-58-57" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'></a><br />

<p>- HDFS 로그 데이터 Dataframe으로 처리하여 읽기</p>
...
<a href="https://ibb.co/yq50PbD"><img src="https://i.ibb.co/892MsSJ/Untitled-50.png" alt="Untitled-50" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'></a><br />